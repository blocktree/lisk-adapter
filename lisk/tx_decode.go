...
import (
	...
	"github.com/blocktree/lisk-adapter/lisk_txsigner"
	"github.com/blocktree/lisk-adapter/transactions"
...
func (decoder *TransactionDecoder) SignRawTransaction(wrapper openwallet.WalletDAI, rawTx *openwallet.RawTransaction) error {
	...
	if keySignatures != nil {
		for _, keySignature := range keySignatures {
			...
			sig, err := lisk_txsigner.Default.SignTransactionHash(msg, keyBytes, owcrypt.ECC_CURVE_ED25519)

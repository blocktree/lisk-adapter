...
import (
	"context"
	"fmt"
	apiclient "github.com/blocktree/lisk-adapter/api"
...
type WalletManager struct {
	...
	Blockscanner    *LSKBlockScanner                //区块扫描器
...
func NewWalletManager() *WalletManager {
	...
	wm.Blockscanner = NewLSKBlockScanner(&wm)
...
//GetAccount
func (wm *WalletManager) GetAccount(address string) (*LSKAccount, error) {
	...
	if q.Accounts != nil && len(q.Accounts) != 0 {
		...
		lskAccount.UnconfirmedBalance = IntToBalance(0)
	}
	return lskAccount, nil
}
